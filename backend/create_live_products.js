...
async function createLiveProducts() {
  ...
  const products = {
    ...
    resume: {
      basic: {
        ...
        description: 'Professional AI-generated resume with ATS optimization, beautiful Canva templates, and 1 revision.',
        price: 2900, // $29.00
        features: [
      ...
      professional: {
        ...
        description: 'Complete career package with resume, cover letter, LinkedIn optimization, and premium templates.',
        price: 5900, // $59.00
        features: [
          'Everything in Basic',
      ...
      executive: {
        ...
        description: 'Luxury executive package with premium design, 1-on-1 consultation, and unlimited revisions.',
        price: 9900, // $99.00
        features: [
  ...
  try {
    ...
    for (const [packageType, packageData] of Object.entries(products.resume)) {
      ...
      console.log(`✅ Price created: ${price.id} - $${packageData.price/100}`);
    ...
    for (const [packageType, data] of Object.entries(createdProducts.resume)) {
      ...
      console.log(`│ ${packageType.padEnd(15)} │ ${price.padEnd(11)} │ ${data.product.substring(0, 20)}... │`);
    }
    ...
    console.log('4. 📊 View in Stripe Dashboard: https://dashboard.stripe.com/products');
    ...
    if (error.code === 'api_key_invalid') {
      ...
      console.log('💡 Make sure you\'re using the correct live key: sk_live_...');
    }
