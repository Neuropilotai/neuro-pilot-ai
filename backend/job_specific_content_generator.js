...
class JobSpecificContentGenerator {
  constructor() {
    ...
    this.contentTemplates = {
      ...
      entry_level: {
        summary_templates: {
          retail:
            "Enthusiastic and reliable {position} candidate with strong customer service skills and {experience}. Eager to contribute to team success while developing professional skills in a fast-paced retail environment.",
          food_service:
            "Dedicated team player with {experience} and excellent communication skills. Committed to providing outstanding customer service and maintaining high standards of food safety and cleanliness.",
          general:
            "Motivated and reliable individual with {experience} seeking an entry-level position. Strong work ethic, excellent interpersonal skills, and eager to learn and contribute to organizational success.",
        },
          ...
          retail: [
            {
              ...
              period: "2023 - Present",
              description:
                "Provided excellent customer service, processed transactions accurately, maintained store appearance, and achieved sales targets.",
            },
          ],
          food_service: [
            {
              ...
              period: "2023 - Present",
              description:
                "Delivered fast, friendly customer service, maintained food safety standards, handled cash transactions, and supported team operations.",
            },
          ],
        },
        skills_focus: [
      ...
      professional: {
        summary_templates: {
          technology:
            "Results-driven {position} with {experience} in software development and technology solutions. Proven track record of delivering high-quality projects, collaborating effectively with cross-functional teams, and staying current with emerging technologies.",
          finance:
            "Detail-oriented {position} with {experience} in financial analysis and reporting. Strong analytical skills with expertise in financial modeling, risk assessment, and regulatory compliance.",
          healthcare:
            "Compassionate {position} with {experience} in patient care and clinical operations. Dedicated to providing quality healthcare services while maintaining strict adherence to medical protocols and patient safety standards.",
          general:
            "Experienced {position} with {experience} in {industry}. Proven ability to manage complex projects, drive process improvements, and deliver measurable results in dynamic business environments.",
        },
        experience_templates: {
          technology: [
            {
              ...
              period: "2021 - Present",
              description:
                "Developed and maintained web applications using modern frameworks, collaborated with agile teams, and implemented automated testing procedures resulting in 25% reduction in deployment issues.",
            },
          ],
          finance: [
            {
              ...
              period: "2021 - Present",
              description:
                "Conducted comprehensive financial analysis, prepared detailed reports for senior management, and identified cost optimization opportunities resulting in $2M annual savings.",
            },
          ],
        },
        skills_focus: [
      ...
      executive: {
        summary_templates: {
          general:
            "Visionary {position} with {experience} driving organizational transformation and sustainable growth. Proven expertise in strategic planning, operational excellence, and stakeholder management with a track record of delivering exceptional business results.",
          technology:
            "Strategic technology leader with {experience} in digital transformation and innovation. Expert in scaling organizations, building high-performing teams, and driving technology initiatives that deliver competitive advantage.",
          finance:
            "Senior financial executive with {experience} in corporate finance, M&A, and capital markets. Demonstrated success in optimizing financial performance, managing risk, and creating shareholder value.",
        },
        experience_templates: {
          general: [
            {
              ...
              period: "2018 - Present",
              description:
                "Led organization-wide transformation initiatives, managed $50M+ operational budget, and drove strategic initiatives resulting in 30% improvement in operational efficiency and $15M cost reduction.",
            },
          ],
        },
        skills_focus: [
      ...
      creative: {
        summary_templates: {
          design:
            "Creative {position} with {experience} in visual design and brand development. Passionate about creating compelling visual experiences that drive engagement and achieve business objectives.",
          marketing:
            "Innovative {position} with {experience} in digital marketing and brand strategy. Proven ability to develop creative campaigns that increase brand awareness and drive customer acquisition.",
          content:
            "Dynamic {position} with {experience} in content creation and storytelling. Expert in developing engaging content across multiple channels that resonates with target audiences.",
        },
        skills_focus: [
          "creative thinking",
          "visual design",
      ...
      technical: {
        summary_templates: {
          software:
            "Skilled {position} with {experience} in software development and system architecture. Expertise in {key_technologies} with a focus on building scalable, maintainable solutions.",
          ...
          infrastructure:
            "Technical {position} with {experience} in cloud infrastructure and DevOps. Expert in designing and implementing scalable systems that ensure high availability and performance.",
        },
        skills_focus: [
      ...
      sales: {
        summary_templates: {
          ...
          retail:
            "Customer-focused {position} with {experience} in retail sales and customer relationship management. Proven ability to drive revenue growth through exceptional service and product knowledge.",
        },
        skills_focus: [
  ...
  generateJobSpecificContent(jobAnalysis, candidateInfo, language = "english") {
    ...
    const content = {
      professional_summary: this.generateSummary(
        category,
        industry,
        candidateInfo,
        seniority,
      ),
      work_experience: this.generateExperience(
        category,
        industry,
        candidateInfo,
        seniority,
      ),
      core_skills: this.generateSkills(
        category,
        industry,
        candidateInfo,
        seniority,
  ...
  generateSummary(category, industry, candidateInfo, seniority) {
    const templates =
      this.contentTemplates[category]?.summary_templates ||
      this.contentTemplates.professional.summary_templates;
    const template =
      templates[industry] ||
      templates.general ||
      "Experienced {position} with {experience} in {industry}. Strong professional background and proven track record of success.";

    const position =
      candidateInfo.target_position || candidateInfo.name || "Professional";
    ...
    if (this.industryModifiers[industry]) {
      const keywords = this.industryModifiers[industry].keywords
        .slice(0, 2)
        .join(" and ");
  ...
  generateExperience(category, industry, candidateInfo, seniority) {
    const experienceBase =
      this.contentTemplates[category]?.experience_templates?.[industry] ||
      this.contentTemplates.professional.experience_templates.general ||
      [];

    const actionWords = this.seniorityModifiers[seniority]?.action_words || [
      "managed",
      "developed",
    ];
    ...
    const experience = experienceBase.map((job) => ({
      ...job,
      description: this.enhanceJobDescription(
        job.description,
        actionWords,
        industry,
        seniority,
  ...
  generateCertifications(category, industry) {
    const certifications =
      this.contentTemplates[category]?.certifications || [];
  ...
  getContentStrategy(jobAnalysis) {
    ...
    return {
      primary_focus: this.seniorityModifiers[seniority]?.focus || [
        "experience",
        "skills",
      ],
      ...
      emphasis_areas:
        jobAnalysis.content_recommendations?.section_emphasis || [],
    };
  }
