...
async function testSmartResumeAgent() {
  ...
  const mcdonaldsOrder = {
    id: Date.now(),
    jobDescription: 'Crew Team Member at McDonald\'s. No experience required. We will train. Looking for reliable, friendly individuals who can work in a fast-paced environment. Responsibilities include taking orders, preparing food, cleaning, and providing excellent customer service.',
  ...
  try {
    ...
    console.log('Design Quality:', mcdonaldsResult.canva_design?.design_quality);
    console.log('Industry Optimized:', mcdonaldsResult.canva_design?.industry_specific);
    ...
    console.log('Summary:', mcdonaldsContent['Professional Summary'] || mcdonaldsContent.summary);
    console.log('');
  ...
  const cnRailCEOOrder = {
    id: Date.now() + 1,
    jobDescription: 'Chief Executive Officer at CN Rail. Leading Fortune 500 transportation company with $14B revenue. Seeking visionary leader with 15+ years executive experience in transportation, logistics, or industrial sector. Responsible for strategic direction, stakeholder relations, P&L management, and driving operational excellence across North American rail network.',
    companyName: 'Canadian National Railway Company',
    candidateInfo: {
      name: 'Michael Thompson',
      experience: '20 years executive leadership in transportation',
      skills: 'Strategic Leadership, P&L Management, Board Relations, Operational Excellence, Digital Transformation, Stakeholder Management, M&A, Risk Management',
  ...
  try {
    ...
    console.log('Industry Optimized:', cnRailResult.canva_design?.industry_specific);
    ...
    console.log('Executive Summary:', cnRailContent['Executive Summary'] || cnRailContent['Professional Summary'] || cnRailContent.summary);
    console.log('');
  ...
  const techStartupOrder = {
    id: Date.now() + 2,
    jobDescription: 'Senior Full-Stack Developer at fast-growing FinTech startup. Looking for React/Node.js expert with 5+ years experience. Must have experience with microservices, AWS, and agile development. Equity package available. Remote-friendly culture.',
    companyName: 'FinTech Innovations Inc.',
    candidateInfo: {
      name: 'Alex Chen',
      experience: '6 years full-stack development',
      skills: 'React, Node.js, TypeScript, AWS, Docker, Kubernetes, MongoDB, GraphQL, Agile, TDD',
  ...
  try {
    ...
    console.log('Industry Optimized:', techResult.canva_design?.industry_specific);
  ...
  const creativeMarketingOrder = {
    id: Date.now() + 3,
    jobDescription: 'Creative Marketing Manager at innovative design agency. Leading brand campaigns for Fortune 500 clients. Need 4+ years marketing experience with focus on digital campaigns, brand strategy, and creative direction. Portfolio required.',
    companyName: 'Creative Collective Agency',
    candidateInfo: {
      name: 'Emma Rodriguez',
      experience: '5 years digital marketing and brand strategy',
      skills: 'Brand Strategy, Digital Campaigns, Creative Direction, Adobe Creative Suite, Social Media, Content Marketing, Analytics',
  ...
  try {
    const creativeResult = await resumeAgent.processOrder(creativeMarketingOrder);
    ...
    console.log('Industry Optimized:', creativeResult.canva_design?.industry_specific);
  ...
  console.log('• CN Rail CEO: Strategic leadership, P&L focus, board experience');
  console.log('• Tech Startup: Technical skills, project focus, innovation emphasis');
  console.log('• Creative Agency: Portfolio highlight, brand strategy, creative achievements');
  console.log('');
  ...
  console.log('The agent now intelligently creates different resumes for different jobs,');
  console.log('from entry-level McDonald\'s positions to Fortune 500 CEO roles!');
}
