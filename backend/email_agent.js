...
class EmailAgent {
    ...
    async checkForEmailReplies() {
        ...
        console.log(`[${new Date().toLocaleTimeString()}] 📧 Checking Neuro.Pilot.AI@gmail.com for customer replies...`);
    ...
    async processEmailOrder(emailData) {
        try {
            ...
            if (orderInfo.isComplete()) {
                ...
                // Generate resume
                const resumeResult = await this.pdfGenerator.generateProfessionalResume(orderInfo);
...
if (require.main === module) {
    ...
    const sampleOrder = {
        ...
        industry: 'Technology',
        experience: '8-10',
        keywords: 'Product Strategy, Agile, User Research, Data Analytics, Leadership',
