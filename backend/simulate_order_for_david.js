...
async function simulateOrderForDavid() {
    ...
    const orderData = {
        ...
        experience: '11-15',
        keywords: 'IT Management, Project Management, Digital Transformation, Team Leadership, Budget Management, Vendor Relations',
        jobDescription: 'Seeking a Senior IT Manager position at Sodexo to lead digital transformation initiatives and manage cross-functional teams.',
        resumeUploaded: true,
        status: 'pending',
    ...
    console.log('│ https://neuropilot-ai.com/order?id=' + orderData.orderId.slice(-8) + '    │');
    console.log('│                                                 │');
...
4 AI Agents | ATS-Optimized | Industry-Specific Keywords
        ...
        const resumePath = path.join(outputDir, `David_Mikulis_Senior_IT_Manager_Resume.txt`);
        ...
        console.log('\n🎯 Order Complete!');
        console.log('✅ David\'s resume has been delivered to david.mikulis@sodexo.com');
